...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT account_key, email, name_first, permission, password FROM accounts WHERE email = ?";
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                if($stmt->num_rows == 1){                    
                    ...
                    $stmt->bind_result($account_key, $email, $name_first, $permission, $hashed_password);
                    if($stmt->fetch()){
